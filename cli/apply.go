	...
	for _, result := range results {
		for _, resource := range resources {
			if resource.Kind == result.Kind {
				...
				result := resource.PutFn(resource.Kind, name, result, options.autogenerated)
				if result != nil {
...
func (resource Resource) handleResourceOperation(name string, resourceObject interface{}, operation string, autogeneratedOption bool) (*http.Response, error) {
	...
	if !autogeneratedInLabels && autogeneratedOption {
		return nil, nil
	}
...
func (resource Resource) PutFn(resourceName string, name string, resourceObject interface{}, autogenerated bool) *ResourceOperationResult {
	...
	response, err := resource.handleResourceOperation(name, resourceObject, "put", autogenerated)
	if err != nil {
	...
	if response.StatusCode == 404 {
		...
		return resource.PostFn(resourceName, name, resourceObject, autogenerated)
	}
...
func (resource Resource) PostFn(resourceName string, name string, resourceObject interface{}, autogenerated bool) *ResourceOperationResult {
	...
	formattedError := fmt.Sprintf("Resource %s:%s error: ", resourceName, name)
	response, err := resource.handleResourceOperation(name, resourceObject, "post", autogenerated)
	if err != nil {
		fmt.Printf("%s%v\n", formattedError, err)
		return &failedResponse
	}
