...
import type { AcceptWorkspaceInvitationData, AcceptWorkspaceInvitationError, AcceptWorkspaceInvitationResponse, CreateAgentData, CreateAgentError, CreateAgentResponse, CreateApiKeyForServiceAccountData, CreateApiKeyForServiceAccountError, CreateApiKeyForServiceAccountResponse, CreateFunctionData, CreateFunctionError, CreateFunctionResponse, CreateIntegrationConnectionData, CreateIntegrationConnectionError, CreateIntegrationConnectionResponse, CreateKnowledgebaseData, CreateKnowledgebaseError, CreateKnowledgebaseResponse, CreateModelData, CreateModelError, CreateModelResponse, CreatePolicyData, CreatePolicyError, CreatePolicyResponse, CreatePrivateClusterError, CreatePrivateClusterResponse, CreateWorkspaceServiceAccountData, CreateWorkspaceServiceAccountError, CreateWorkspaceServiceAccountResponse, CreateWorspaceData, CreateWorspaceError, CreateWorspaceResponse, DeclineWorkspaceInvitationData, DeclineWorkspaceInvitationError, DeclineWorkspaceInvitationResponse, DeleteAgentData, DeleteAgentError, DeleteAgentResponse, DeleteApiKeyForServiceAccountData, DeleteApiKeyForServiceAccountError, DeleteApiKeyForServiceAccountResponse, DeleteFunctionData, DeleteFunctionError, DeleteFunctionResponse, DeleteIntegrationConnectionData, DeleteIntegrationConnectionError, DeleteIntegrationConnectionResponse, DeleteKnowledgebaseData, DeleteKnowledgebaseError, DeleteKnowledgebaseResponse, DeleteModelData, DeleteModelError, DeleteModelResponse, DeletePolicyData, DeletePolicyError, DeletePolicyResponse, DeletePrivateClusterData, DeletePrivateClusterError, DeletePrivateClusterResponse, DeleteWorkspaceData, DeleteWorkspaceError, DeleteWorkspaceResponse, DeleteWorkspaceServiceAccountData, DeleteWorkspaceServiceAccountError, DeleteWorkspaceServiceAccountResponse, GetAgentData, GetAgentError, GetAgentResponse, GetConfigurationError, GetConfigurationResponse, GetFunctionData, GetFunctionError, GetFunctionResponse, GetIntegrationConnectionData, GetIntegrationConnectionError, GetIntegrationConnectionModelData, GetIntegrationConnectionModelEndpointConfigurationsData, GetIntegrationConnectionModelEndpointConfigurationsError, GetIntegrationConnectionModelEndpointConfigurationsResponse, GetIntegrationConnectionModelError, GetIntegrationConnectionModelResponse, GetIntegrationConnectionResponse, GetIntegrationData, GetIntegrationError, GetIntegrationResponse, GetKnowledgebaseData, GetKnowledgebaseError, GetKnowledgebaseResponse, GetModelData, GetModelError, GetModelResponse, GetPolicyData, GetPolicyError, GetPolicyResponse, GetPrivateClusterData, GetPrivateClusterError, GetPrivateClusterHealthData, GetPrivateClusterHealthError, GetPrivateClusterHealthResponse, GetPrivateClusterResponse, GetTemplateContentsData, GetTemplateContentsError, GetTemplateContentsResponse, GetTemplateData, GetTemplateError, GetTemplateFileContentsData, GetTemplateFileContentsError, GetTemplateFileContentsResponse, GetTemplateResponse, GetWorkspaceData, GetWorkspaceError, GetWorkspaceResponse, GetWorkspaceServiceAccountsError, GetWorkspaceServiceAccountsResponse, InviteWorkspaceUserData, InviteWorkspaceUserError, InviteWorkspaceUserResponse, LeaveWorkspaceData, LeaveWorkspaceError, LeaveWorkspaceResponse, ListAgentRevisionsData, ListAgentRevisionsError, ListAgentRevisionsResponse, ListAgentsError, ListAgentsResponse, ListAllPendingInvitationsError, ListAllPendingInvitationsResponse, ListApiKeysForServiceAccountData, ListApiKeysForServiceAccountError, ListApiKeysForServiceAccountResponse, ListFunctionRevisionsData, ListFunctionRevisionsError, ListFunctionRevisionsResponse, ListFunctionsError, ListFunctionsResponse, ListIntegrationConnectionModelsData, ListIntegrationConnectionModelsError, ListIntegrationConnectionModelsResponse, ListIntegrationConnectionsError, ListIntegrationConnectionsResponse, ListKnowledgebaseRevisionsData, ListKnowledgebaseRevisionsError, ListKnowledgebaseRevisionsResponse, ListKnowledgebasesError, ListKnowledgebasesResponse, ListLocationsError, ListLocationsResponse, ListMcpHubDefinitionsError, ListMcpHubDefinitionsResponse, ListModelRevisionsData, ListModelRevisionsError, ListModelRevisionsResponse, ListModelsError, ListModelsResponse, ListPoliciesError, ListPoliciesResponse, ListPrivateClustersError, ListPrivateClustersResponse, ListTemplatesError, ListTemplatesResponse, ListWorkspacesError, ListWorkspacesResponse, ListWorkspaceUsersError, ListWorkspaceUsersResponse, RemoveWorkspaceUserData, RemoveWorkspaceUserError, RemoveWorkspaceUserResponse, UpdateAgentData, UpdateAgentError, UpdateAgentResponse, UpdateFunctionData, UpdateFunctionError, UpdateFunctionResponse, UpdateIntegrationConnectionData, UpdateIntegrationConnectionError, UpdateIntegrationConnectionResponse, UpdateKnowledgebaseData, UpdateKnowledgebaseError, UpdateKnowledgebaseResponse, UpdateModelData, UpdateModelError, UpdateModelResponse, UpdatePolicyData, UpdatePolicyError, UpdatePolicyResponse, UpdatePrivateClusterData, UpdatePrivateClusterError, UpdatePrivateClusterHealthData, UpdatePrivateClusterHealthError, UpdatePrivateClusterHealthResponse, UpdatePrivateClusterResponse, UpdateWorkspaceData, UpdateWorkspaceError, UpdateWorkspaceResponse, UpdateWorkspaceServiceAccountData, UpdateWorkspaceServiceAccountError, UpdateWorkspaceServiceAccountResponse, UpdateWorkspaceUserRoleData, UpdateWorkspaceUserRoleError, UpdateWorkspaceUserRoleResponse } from './types.gen.js';
 ...
 */
export const listTemplates = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
 ...
 */
export const getTemplate = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetTemplateData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetTemplateResponse, GetTemplateError, ThrowOnError>({
        ...options,
        url: '/templates/{templateName}'
    });
};

export const getTemplateContents = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetTemplateContentsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetTemplateContentsResponse, GetTemplateContentsError, ThrowOnError>({
        ...options,
        url: '/templates/{templateName}/contents'
    });
};

export const getTemplateFileContents = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetTemplateFileContentsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetTemplateFileContentsResponse, GetTemplateFileContentsError, ThrowOnError>({
        ...options,
